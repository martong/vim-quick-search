...
map <Leader>a :let @/="<C-R><C-W>" \| LAg! --cpp --skip-vcs-ignores "\b<C-R><C-W>\b"<cr>
...
vmap <leader>a :<C-u>call <SID>VSetSearchAg()<CR>:execute 'noautocmd LAg! --cpp --skip-vcs-ignores "' . g:visual_star_search_ag_search_buf . '"'<CR>
